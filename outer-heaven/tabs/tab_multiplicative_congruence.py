...
class TabMultiplicativeCongruence(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        title = tk.Label(self, text="CONGRUENCIA MULTIPLICATIVA", font=("Arial", 13, "bold")) 
        ...
        self.t_label = tk.Label(self, text="t:")  
        self.t_label.grid(row=1, column=0, pady=(100, 0)) 
        self.t_entry = tk.Entry(self, validate="key", validatecommand=vcmd)
        self.t_entry.grid(row=1, column=0, pady=(150, 0))
        
        self.g_label = tk.Label(self, text="g:")  
        self.g_label.grid(row=1, column=0, pady=(200, 0)) 
        self.g_entry = tk.Entry(self, validate="key", validatecommand=vcmd)
        self.g_entry.grid(row=1, column=0, pady=(250, 0))
    ...
    def validate_fields(self):
        if not self.seed_entry.get() or not self.iteration_entry.get() or not self.t_entry.get() or not self.g_entry.get() or not self.min_entry.get() or not self.max_entry.get():
    ...
    def generate_numbers(self):
        ...
        generator = MultiplicativeCongruence(seed, num_iterations, t, g, min_val, max_val)
